...
(function () {
  ...
  var MASTERY_FACT = {
    ...
    i_qigu: ['奇古獸傷害公式：骰(武器傷害)×(1＋魔法傷害/16)＋額外值，必中、算魔法傷害', '基準仍吃目標魔抗 → 精通無視魔抗（含觸發特效）；奇古獸特效觸發率＝(1＋強化值)%'],
    i_magicsword: ['非魔杖近戰武器改走奇古獸傷害公式（必中・魔法傷害）、攻速 +30%', '注意：仍吃目標魔抗——「無視魔抗」是奇古獸精通限定'],
    i_illusion: ['歐吉：每 2 秒近戰 3D20＋智力/5×(1＋等級/10)', '巫妖：每 3 秒魔法（必中、吃魔抗）3D20＋智力/5×(1＋等級/10)', '鑽石高崙：每 1 秒近戰 2D20＋智力/5×(1＋等級/5)，命中後 10% 追加冰矛圍籬', '沒有持續時間限制：幻覺 buff 在就一直打'],
    ...
    k_tough: ['護甲身軀：傷害減免 +⌊(10−AC)/10⌋ → +⌊(10−AC)/5⌋（約翻倍）；藥水 +50% 只在 HP<40% 時生效'],
