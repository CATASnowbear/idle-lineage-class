...
(function () {
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '🏛️ 傳統模式（硬核：拿掉「自己強化」）', lines: [
      ...
      '<b>③ 施法卷軸照常取得</b>：傳統模式（含經典＋傳統）仍能從怪掉、黑市、寶箱、兌換拿到對武器／盔甲／飾品施法的卷軸，供<b>碧恩賦予祝福、飾品卷軸升級</b>用——只是沒有「自己強化」那個面板（經典＋傳統因隱藏碧恩，卷軸主要剩飾品升級與兌換用途）。',
  ...
  function renderMode() {
    ...
    var c2 = card('🛠️ 強化 · 裝備（只看有沒有開「傳統」）', tbl(
      ...
      r('施法卷軸（怪物·黑市·寶箱·兌換）', OK, OK, OK, OK)
    ) + '<div class="m-wiki-desc" style="margin-top:6px;">・傳統＝沒有「自己強化」面板，掉落／兌換／製作／<b>歐西里斯寶箱開出</b>的裝備<b>自帶一個隨機強化值</b>；商店買、試煉兌換的一律 +0。施法卷軸各模式都照常取得（供碧恩賦予祝福、飾品卷軸升級）。</div>');
