 ...
 * ========================================================================== */
const CODE_VERSION = 'code-9d25d1f5d1fc';   // ← scripts/stamp-sw-version.mjs 自動覆寫,勿手改
const BUILD_ID     = '0705-1059'; // ← stamp 在 CODE_VERSION 變動時一起更新成台灣時間 MMDD-HHMM(僅供畫面辨識版本)
